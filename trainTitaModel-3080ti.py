...
parser.add_argument('--train_list', type=str, default="/home/ycen/data/VoxCeleb2Dataset/train_list.txt",
                    help='The path of the training list, https://www.robots.ox.ac.uk/~vgg/data/voxceleb/meta/train_list.txt')
parser.add_argument('--train_path', type=str, default="/home/ycen/data/VoxCeleb2Dataset/wav",
                    help='The path of the training data, eg:"/data08/VoxCeleb2/train/wav" in my case')
parser.add_argument('--eval_list', type=str, default="/home/ycen/data/VoxCeleb1Dataset/veri_test2.txt",
...
parser.add_argument('--eval_path', type=str, default="/home/ycen/data/VoxCeleb1Dataset/wav",
                    help='The path of the evaluation data, eg:"/data08/VoxCeleb1/test/wav" in my case')
parser.add_argument('--musan_path', type=str, default="/home/ycen/data/musan_split",
                    help='The path to the MUSAN set, eg:"/data08/Others/musan_split" in my case')
parser.add_argument('--rir_path', type=str, default="/home/ycen/data/rirs/RIRS_NOISES/simulated_rirs",
